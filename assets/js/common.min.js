...
Barba.Dispatcher.on("newPageReady", function () {
    if ($("#js-fullpage").length) new Parallax($(".js-parallax-picture").get(0)), new Parallax($(".js-parallax-picturelight").get(0)), new Parallax($(".js-parallax-star").get(0)), new Parallax($(".js-parallax-nav").get(0));
